...
const arcanaCards = [
  {
    ...
    cardIcon: "0.png",
    imgUrl:
      "https://www.falcom.co.jp/sen4/assets/character/detail/visual/campanella.png",
    arcanaDescription: "Beginnings, Innocence, A free spirit",
    enforcerName: "Campanella",
    enforcerTitle: "Enforcer No.0 ~ The Fool",
    charDescription:
      "Campanella is a mysterious individual whose true self can't be seen. Due to the ambiguous nature of his gender, he is a hard individual to classify. But, what is known, is that he is a cold individual who likes to have fun by teasing and tormenting people through his taunts.",
  },
  {
    number: "I",
    id: "e1",
  ...
  },
  {
    ...
    cardIcon: "2.png",
    imgUrl:
      "https://cdn.myanimelist.net/images/characters/9/184517.jpg?_gl=1*m05df8*_ga*NzExMjcwMDYuMTY2MDUwOTM3Ng..*_ga_26FEP9527K*MTY2MDUwOTM3Ni4xLjEuMTY2MDUwOTM4Mi41NA..",
  ...
  },
  {
    ...
    cardIcon: "3.png",
    imgUrl:
      "https://www.falcom.co.jp/kuro2/assets/character/single/illust/lucrezia.webp",
    arcanaDescription: "Femininity, Beauty, Nature",
    enforcerName: "Lucrezia Isselee",
  ...
  },
  {
    ...
    charDescription:
      "She tends not to reveal her true self and hides her emotions behind a veil. Despite this, she does care about people and hates the idea of a country being destroyed by the Glorious. She also suffers from guilt over killing the man she loved",
  },
  {
    number: "VII",
    id: "e7",
  ...
  },
  {
    ...
    cardIcon: "8.png",
    imgUrl:
      "https://www.falcom.co.jp/kuro2/assets/character/single/illust/walter.webp",
  ...
  },
  {
    ...
    cardIcon: "9.png",
    imgUrl:
      "https://www.falcom.co.jp/sen4/assets/character/detail/visual/kluger.png",
  ...
  },
  {
    ...
    cardIcon: "10.png",
    imgUrl:
      "https://i0.wp.com/kisekicrack.esterior.net/wp-content/uploads/2018/05/r6f3UgA.png?ssl=1",
    arcanaDescription: "Karma, Destiny,",
    enforcerName: "Bleublanc",
    enforcerTitle: "Enforcer No.10 ~ Phantom Thief",
    charDescription:
      "Bleublanc is a notorious phantom thief who operates across Zemuria. In Ouroboros, he is ranked as Enforcer No. X: The mysterious, gentlemanly phantom thief, Bleublanc. He has a flamboyant and theatrical personality.",
    scale: 1.3,
    containeImage: true,
  },
  {
  ...
  },
  {
    ...
    cardIcon: "13.png",
    imgUrl:
      "https://www.falcom.co.jp/sen4/assets/character/detail/visual/joshua.png",
    arcanaDescription: "Endings, Transformation",
    enforcerName: "Joshua",
    enforcerTitle: "Enforcer No.13 ~ Black Fang",
    charDescription:
      'Joshua Bright is a kind-hearted and intelligent introvert. He also tends to conformity and is sometimes fearful. In his childhood, these traits express themselves as shyness and passivity. Later in life he describes his childhood self as a "weakling and liar".',
  },
  {
    number: "XIV",
    id: "e14",
  ...
  },
  {
    ...
    cardIcon: "17.png",
    imgUrl:
      "https://www.falcom.co.jp/sen4/assets/character/detail/visual/shirley.png",
...
function App() {
  return (
    <div className="App">
      <a id="button" href="#navlist">
        Go to list
      </a>
      <nav id="navlist">
        <header className="App-header">Arcana List</header>
        <ul>
          {arcanaCards.map((post, idx) => (
            <a href={"#" + post.id} key={idx} target="">
              <li>
                <img
                  width="44"
                  height="66"
